                ...
                <div className="col-sm-12 mt-4 mt-md-0 col-md-6 col-xl-8">
                    <div className="row">
                        <div className="col-md-12 col-xl-6">
                            ...
                            <p>
                                My goal is to become a full stack developer. So I will try best myselft to imporove skills everyday. I hope that I will have chance to join your team to help me reach my goal!
                            </p>
                        </div>
                        <div className="col-md-12 col-xl-6">
